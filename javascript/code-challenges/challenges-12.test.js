...
const replaceZeros = (string) => {
  const originalValue = /0/g;
  const replaceWith = "zero";
  let result = string.replace(originalValue, replaceWith);
...
const validatePhoneNumber = (phoneNumber) => {
  ...
  //================== not sure how to solve this one as well
};

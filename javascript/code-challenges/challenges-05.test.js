...
const toLastNames = people => {
  ...
  people.map(function (element) {
    return `${element.firtsName} ${element.lastName}`
  });
};
...
given an array of objects as input, uses reduce 
to find the total amount purchased. Each object 
contains the keys `item` and `purchasePrice` like the example.

...
const addTwo = (arr) => {
  // Solution code here...
    ...
    for (let r = 0; r < arr.length; r++) {
      challenge1Array.push(arr[r]+2)
      
    }
    return challenge1Array
...
const typeNum = (arr) => {
  // Solution code here...
    ...
    let challenge2Array = arr.filter(e => {
      return (typeof(e) === 'number')
    })
    return challenge2Array
...
const containsAnd = (arr) => {
  // Solution code here...
  let challenge3Array = arr.filter(element => {
    return (element.includes('and'))
  })
  return challenge3Array
};
...
const oddValues = (arr) => {
  // Solution code here...
  let challenge4Array = arr.filter(e => {
    return (e % 2)
  })
  return challenge4Array
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
    ...
    for (let i = 0; i < arr.length; i++) {
      challenge5Array = arr.filter(e => {
        return (!(forbiddenValues.includes(e)))
      })
      
    }
    return challenge5Array
